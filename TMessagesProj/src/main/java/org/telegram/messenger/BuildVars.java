...
public class BuildVars {
    ...
    public static boolean isStandaloneApp() {
        if (standaloneApp == null) {
            standaloneApp = ApplicationLoader.applicationContext != null && "org.electron.messager.web".equals(ApplicationLoader.applicationContext.getPackageName());
        }
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.electron.messager.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
